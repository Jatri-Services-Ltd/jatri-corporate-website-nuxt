            ...
            <div class="border border-lightGrey rounded-2xl p-5">
              <div class="flex items-center gap-5">
                ...
                <div>
                  ...
                  <p class="text-base lg:text-xl font-medium text-dark font-inter">{{data.data.employment_status.replaceAll('_', ' ').replaceAll('-', ' ')}}</p>
                </div>
              </div>
              ...
              <div class="flex items-center gap-5 pt-4">
                ...
                <div>
                  ...
                  <p class="text-base lg:text-xl font-medium text-dark" >{{new Date(data.data.deadline).toLocaleDateString()}}</p>
                </div>
              </div>
              <div class="border-b ml-10 pt-4"></div>
              <div class="flex items-center gap-5 pt-4">
        ...
        <div class="p-4 md:p-6">
          <div class="h-[400px] md:h-auto overflow-y-scroll pb-24 md:pb-0">
            ...
            <div class="block sm:flex gap-0 sm:gap-8">
              <div class="w-full">
                ...
                <input required v-model="applicationSubmitForm.name" type="text" class="w-full p-4 bg-[#F7F7F7] placeholder:text-sm placeholder:text-[#676769]" placeholder="Enter full name">
              </div>
              <div class="w-full">
                <label class="text-base font-medium text-dark pb-[10px] block" for="">Email address</label>
                <input required v-model="applicationSubmitForm.email" type="text" class="w-full p-4 bg-[#F7F7F7] placeholder:text-sm placeholder:text-[#676769]" placeholder="Enter email address">
              </div>
            </div>
            <div class="block sm:flex gap-0 sm:gap-8 mt-6">
              <div class="w-full">
                ...
                <input required  maxlength="11" v-model="applicationSubmitForm.mobile_number" type="text" class="w-full p-4 bg-[#F7F7F7] placeholder:text-sm placeholder:text-[#676769]" placeholder="Enter mobile number">
              </div>
              <div class="w-full">
                <label class="text-base font-medium text-dark pb-[10px] block" for="">LinkedIn profile</label>
                <input required v-model="applicationSubmitForm.linkedin_profile" type="text" class="w-full p-4 bg-[#F7F7F7] placeholder:text-sm placeholder:text-[#676769]" placeholder="Enter linkedin profile link">
              </div>
            </div>
            <div class="mt-8">
          ...
          <div class="small-device-bottom-section">
            <div class="mt-4 md:mt-12 mb-4 flex justify-center px-4">
              <button @click="handleSubmit" class="h-10 md:h-[60px] w-full md:w-[300px] flex justify-center items-center bg-corporate text-white rounded-full text-sm md:text-xl font-medium">Submit</button>
            </div>
          </div>
        </div>
      </div>

<template>
    ...
    <div class="custom-container">
      <h1 class="text-center text-4xl md:text-[45px] leading-9 md:leading-[52px] font-medium mb-4">Our inspiring leaders</h1>
      <p class="text-center text-base">Lorem ipsum dolor sit amet consectetur. Enim nisl malesuada id euismod congue donec ullamcorper sit. Adipiscing tempus.</p>

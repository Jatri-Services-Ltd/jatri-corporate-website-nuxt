      ...
      <div class="h-[400px] md:h-auto overflow-y-scroll pb-24 md:pb-0">
        ...
        <div class="block sm:flex gap-0 sm:gap-8">
          <div class="w-full">
            ...
            <p class="text-red-500 text-xs" v-if="v$.name.$errors.length">
          ...
          <div class="w-full">
            ...
            <p class="text-red-500 text-xs" v-if="v$.email.$errors.length">
        ...
        <div class="block sm:flex gap-0 sm:gap-8 mt-6">
          <div class="w-full">
            ...
            <input
              ...
              <p class="text-red-500 text-xs" v-if="v$.mobile_number.$errors.length">
        ...
        <div class="mt-8">
          ...
          <div class="relative overflow-hidden">
            ...
            />
            <p class="text-red-500 text-xs" v-if="v$.resume.$errors.length">
              {{ v$.resume.$errors[0].$message }}
            </p>
          </div>
        </div>
      </div>

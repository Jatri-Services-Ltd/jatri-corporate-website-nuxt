...
<template>
  <div class="">
    ...
    <div v-if="!success && !error">
      <div class="flex justify-between items-center p-6 border-b border-b-[#DBDBDB]">
      ...
      <div>
        <div class="h-[400px] md:h-auto overflow-y-scroll p-6 pb-0">
          <p class="text-sm md:text-2xl font-medium mb-4 md:mb-6">Personal information</p>
          <div class="block sm:flex gap-0 sm:gap-8">
            <div class="w-full">
              ...
              <input v-model="v$.name.$model" @blur="v$.name.$touch()" type="text"
                class="w-full px-4 py-[18px] bg-[#F7F7F7] placeholder:text-sm placeholder:text-[#676769] focus:outline-none rounded"
          ...
          <div class="mt-8">
            <p class="text-sm md:text-2xl font-medium">Resume / CV</p>
            ...
            <div class="relative overflow-hidden">
              <button :class="{ 'border border-[#E0293B]': v$.resume?.$errors.length }"
                class="w-full border border-info border-dashed py-[22px] px-5 text-start rounded-2xl">
                  ...
                  <div class="flex gap-5 py-2.5">
                    <div class="flex gap-2 justify-between items-center w-full">
                      ...
                      <div>
                        ...
                        <label class="text-[#E0293B] border-b border-b-[#E0293B] text-sm font-medium cursor-pointer" for="replace">Replace</label>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div class="small-device-bottom-section">
          <div class="mt-4 md:mt-12 mb-10 flex justify-center px-4">
            <button :disabled="isSubmitting" @click="submitForm"
              :class="isSubmitting ? 'opacity-20 cursor-not-allowed' : ''"
              class="md:h-[60px] w-full md:w-[300px] py-4 bg-corporate text-white rounded-full text-sm md:text-xl font-medium">
              Submit
            </button>
          </div>
        </div>

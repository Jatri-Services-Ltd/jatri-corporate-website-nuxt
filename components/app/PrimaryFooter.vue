    ...
    <div class="w-full mx-auto lg:px-[60px] xl:px-[100px] 2xl:px-[200px] bg-[#f04935] py-6 lg:py-8 divide-y divide-[#F6958A] space-y-6">
      ...
      <div class="px-4 lg:px-0 grid grid-cols-2 lg:grid-cols-4 lg:justify-between gap-x-4 gap-y-6 lg:gap-4 pt-6">
        ...
        <div>
          ...
          <ul class="grid gap-4">
            <li>
              <a href="https://rental.jatriweb.team/" class="text-white text-base" target="_blank">{{ $t('n-footer-rental') }}</a>
            </li>
            <li>
              <a href="https://ticket.jatriweb.team/" class="text-white text-base" target="_blank">{{ $t('n-footer-bus-ticketing') }}</a>
            </li>
            <li>
              <a href="https://ticket.jatriweb.team/launch" class="text-white text-base" target="_blank">{{ $t('n-footer-launch-ticketing') }}</a>
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul class="grid gap-4">
            ...
            <li class="flex items-center gap-2">
              ...
              <a class="text-white font-normal text-base" href="tel:09642080808">{{ $t('n-footer-phone') }}</a>
            </li>
            <li class="flex items-center gap-2">
              ...
              <a class="text-white font-normal text-base" href="https://goo.gl/maps/EBDpA4TyPkzsF4mH8" target="_blank" >{{ $t('n-footer-address') }}</a>
            </li>
          </ul>
        </div>
      </div>

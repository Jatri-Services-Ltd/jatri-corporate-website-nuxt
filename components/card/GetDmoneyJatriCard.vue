                    ...
                    <div class="sm:w-1/2 border border-[#EDEDED] bg-white rounded-3xl">
                        ...
                        <div class="p-6 sm:p-4 md:p-6">
                            ...
                            <ul class="grid gap-4 text-base sm:text-sm lg:text-base text-dark">
                                <li v-if="locale === 'en'">
                                    <img src="~/assets/images/jatri-card/arrow-right-icon.png" alt="right arrow">
                                    <span>Go to your nearest <router-link :to="localePath('/available-activation-counters')" class="text-info font-medium underline">available counter</router-link></span>
                                </li>
                                <li v-if="locale === 'bn'">
                                    <img src="~/assets/images/jatri-card/arrow-right-icon.png" alt="right arrow">
                                    <span>আপনার <router-link :to="localePath('/available-activation-counters')" class="text-info font-medium underline">নিকটস্থ কাউন্টার</router-link> এ যান</span>
                                </li>
                                <li>
                                    <img src="~/assets/images/jatri-card/arrow-right-icon.png" alt="right arrow">

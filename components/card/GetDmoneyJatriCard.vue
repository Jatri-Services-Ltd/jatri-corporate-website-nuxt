        ...
        <div class="custom-container">
            <div class="flex flex-col xl:flex-row justify-between gap-6 sm:gap-10">
                <div class="custom-width xl:w-[465px] flex flex-col justify-between">
                    <div>
                        <h3
                            class="sm:w-auto m-auto text-dark text-[28px] leading-9 lg:text-[44px] lg:leading-[60px] xl:text-[57px] xl:leading-[64px] font-medium sm:font-semibold text-center sm:text-left"
                        ...
                        <div class="p-6 sm:p-4 md:p-6">
                            ...
                            <ul class="grid gap-4 text-base sm:text-sm lg:text-base text-dark">
                                <li>
                                    ...
                                    <span>{{$t('get-card-card1-content1')}}</span>
                                </li>
                                <li>
                                    <img src="~/assets/images/jatri-card/arrow-right-icon.png" alt="right arrow">
                                    <span>{{$t('get-card-card1-content2')}}</span>
                                </li>
                                <li>
                                    <img src="~/assets/images/jatri-card/arrow-right-icon.png" alt="right arrow">
                                    <span>{{$t('get-card-card1-content3')}}</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="sm:w-1/2 border border-lightGrey bg-white rounded-3xl">
                        ...
                        <div class="p-6 sm:p-4 md:p-6">
                            ...
                            <ul class="grid gap-4 text-base sm:text-sm lg:text-base text-dark">
                                ...
                                <li>
                                    <img src="~/assets/images/jatri-card/arrow-right-icon.png" alt="right arrow">
                                    <span>{{$t('get-card-card2-content2')}}</span>
                                </li>
                                <li>
                                    <img src="~/assets/images/jatri-card/arrow-right-icon.png" alt="right arrow">
                                    <span>{{$t('get-card-card2-content3')}}</span>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="sm:hidden mt-6">
                <p class="text-secondaryDark text-base">{{ $t('get-card-content') }}</p>
                <div class="flex gap-4 mt-4">
                    <div class="p-3 bg-grey rounded-2xl">
                        <img class="w-10 h-5 sm:w-auto sm:h-auto object-cover mb-5" src="~/assets/images/jatri-card/jatri-logo-small.png" alt="Jatri logo">
                        <div class="inline-block">
                            <a target="_blank" href="https://play.google.com/store/apps/details?id=com.jatri.jatriuser&hl=en&gl=" class="flex items-center gap-1 px-3 py-2 bg-white rounded-full">
                                <img class="w-3 h-3 object-cover" src="~/assets/images/jatri-card/google-play-icon.png" alt="Google play icon">
                                <p class="text-dark text-xs font-medium">{{$t('get-card-play-store')}}</p>
                            </a>
                        </div>
                    </div>
                    <div class="p-3 bg-grey rounded-2xl">
                        <img class="w-[78px] h-4 sm:w-auto sm:h-auto object-cover mb-5" src="~/assets/images/jatri-card/dmoney-logo-small.png" alt="Dmoney logo">
                        <div class="flex justify-between gap-2">
                            <a target="_blank" href="https://apps.apple.com/us/app/dmoney/id1441277786" class="flex items-center gap-1 px-3 py-2 bg-white rounded-full">
                                <img class="w-3 h-3 object-cover" src="~/assets/images/jatri-card/apple-logo-small.png" alt="Google play icon">
...
/* ul li::before {
    content: "";
    background-image: url(~/assets/images/jatri-card/arrow-right-icon.png);

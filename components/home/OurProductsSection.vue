...
.panels .panel {
  @apply h-[460px] w-[340px] overflow-hidden flex-shrink-0 rounded-3xl flex flex-col justify-center transform scale-100 duration-1000 transition-[transform,width]
}
.panel-content {
    @apply px-5 py-6
}

    ...
    <div class="bg-[#F7F7F7] rounded-3xl">
      <div class="flex flex-wrap flex-row-reverse md:flex-row w-full justify-between items-stretch">
        <div class="self-center w-full md:w-[60%] px-5 lg:px-14 xl:px-[106px] pt-6 pb-5 lg:py-10 xl:py-20 order-2 md:order-1">
          ...
          <p class="text-dark text-sm lg:text-[16px] leading-6">{{ $t('n-download-app-description') }}</p>
          <div class="mt-4 lg:mt-6 2xl:mt-12 flex gap-4 lg:gap-6">
            <a href="https://play.google.com/store/apps/details?id=co.jatri.rental.mercent&hl=en&gl=US" target="_blank" class="bg-[#EDEDED] h-[46px] w-[158px] flex justify-center items-center text-dark md:text-sm lg:text-[16px] leading-6 font-medium rounded-full">{{ $t('n-download-app') }}</a>
